...
public class ZeppelinServer extends Application {
  ...
  public static void main(String[] args) throws Exception {
    ZeppelinConfiguration conf = zeppelinConfigurationFactory();
    ...
    //datasource
    jettyServer.setAttribute("cepDataSource", getDataSource());
  ...
  public static Resource getDataSource() throws IOException {
    Resource datasource = null;
    
    try {
      Properties properties = new Properties(); 
      properties.load(ZeppelinServer.class.getClassLoader().getResourceAsStream("datasource.properties"));
      ...
      comboPooledDataSource.setInitialPoolSize(Integer.parseInt(properties.getProperty("initialPoolSize")));                                     
      ...
      comboPooledDataSource.setMaxStatements(Integer.parseInt(properties.getProperty("maxStatements")));
          
      comboPooledDataSource.setAcquireRetryAttempts(Integer.parseInt(properties.getProperty("acquireRetryAttempts")));
      comboPooledDataSource.setPreferredTestQuery(properties.getProperty("preferredTestQuery"));
      comboPooledDataSource.setTestConnectionOnCheckin(Boolean.getBoolean(properties.getProperty("testConnectionOnCheckin")));
      comboPooledDataSource.setTestConnectionOnCheckout(Boolean.getBoolean(properties.getProperty("testConnectionOnCheckout")));
      ...
      datasource = new Resource("java:comp/env/jdbc/cepDS", comboPooledDataSource);
  ...
  public static ZeppelinConfiguration zeppelinConfigurationFactory() throws MalformedURLException, ConfigurationException {
    String fileName = System.getenv().get("ZEPPELIN-SITE-XML");
    if (fileName != null) {
